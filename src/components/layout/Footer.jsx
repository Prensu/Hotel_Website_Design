    ...
    <footer className="footer">
      <div className="footer-top">
        ...
        <div className="footer-newsletter">
          ...
          <p>
            Stay updated with exclusive offers, personalized experiences, and
            curated stories from Ritzio. Subscribe now to be the first to know
            about our latest updates and luxury events.
          </p>
